...
public class Protask {
    ...
    public Boolean getPtPertype() {
        return ptPertype;
    }

    public void setPtPertype(Boolean ptPertype) {
    ...
    public void setPtStatus(Boolean ptStatus) {
    ...
    public Boolean getApprStat() {
        return apprStat;
    }

    public void setApprStat(Boolean apprStat) {
