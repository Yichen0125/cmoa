...
public class Cuscontact {
    ...
    private Boolean ccCgljs;

    private Boolean ccFylx;

    private Boolean ccJczyd;
    ...
    public Boolean getCcCgljs() {
        return ccCgljs;
    }

    public void setCcCgljs(Boolean ccCgljs) {
        this.ccCgljs = ccCgljs;
    }

    public Boolean getCcFylx() {
        return ccFylx;
    }

    public void setCcFylx(Boolean ccFylx) {
        this.ccFylx = ccFylx;
    }

    public Boolean getCcJczyd() {
        return ccJczyd;
    }

    public void setCcJczyd(Boolean ccJczyd) {
        this.ccJczyd = ccJczyd;
    }

    public Byte getCcXqfl() {
        return ccXqfl;
    }

    public void setCcXqfl(Byte ccXqfl) {
        this.ccXqfl = ccXqfl;
    }
