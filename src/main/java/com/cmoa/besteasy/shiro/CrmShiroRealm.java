package com.cmoa.besteasy.shiro;
...
public class CrmShiroRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		try {
			info = new SimpleAuthenticationInfo(principal, hashedCredentials, credentialsSalt,
					realmName);
		} catch (Exception e) {
	...
	public static void main(String[] args) {
		...
		ByteSource salt = ByteSource.Util.bytes("jishubu");
